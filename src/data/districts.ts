import type { DeepReadonly, District } from '../types/simulation.ts';
import { deepFreezeCatalog } from './rules.ts';

export const DISTRICTS: DeepReadonly<District[]> = deepFreezeCatalog([
  {
